...
<div className='flex justify-between p-6'>
    <h1 className='text-4xl font-extrabold text-black '>Beverages</h1>
</div>
{/* banner */}
<div className="flex items-center justify-center">
  <Image src="/drink.webp" alt="Logo" width={1300} height={400} objectFit="fill" className=" hero" />
</div>
{/* cards row 1*/}
...
{/* cards row 3*/}
<div className="flex gap-4 p-4 justify-center md:justify-start">
<div className="bg-white rounded border shadow-md p-4 flex">
    <div className="flex justify-center items-center">
      <img src="deal.webp" alt="Small Image" className="w-16 h-16 object-contain" />
    </div>
    <div className="text-center mt-4">
      <h2 className="text-xl font-bold">Loaded Doner Fries</h2>
      <p className="text-sm text-gray-600 mt-2 text-start">Indulge in premium lean meat,<br /> our signature garlic mayo.</p>
      <p className="text-sm font-bold mt-2 text-start">
        <span className="bg-red-500 text-white rounded px-2 py-1">Special Offer</span>
      </p>
