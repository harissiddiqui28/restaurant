...
<div className='flex justify-between p-6'>
    <h1 className='text-4xl font-extrabold text-black '>Loaded Fries</h1>
</div>
{/* banner */}
<div className="flex items-center justify-center">
  <Image src="/loaded.webp" alt="Logo" width={1300} height={400} objectFit="fill" className=" hero" />
</div>
{/* cards */}

<div className="flex gap-4 p-4 justify-center md:justify-around  flex-col md:flex-row ">
