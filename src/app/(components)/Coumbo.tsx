...
<div className='flex justify-between p-6'>
    <h1 className='text-4xl font-extrabold text-black '>Combo Meals</h1>
</div>
{/* banner */}
<div className="flex items-center justify-center">
  <Image src="/combo.webp" alt="Logo" width={1300} height={400} objectFit="fill" className=" hero" />
</div>
{/* cards row 1*/}
